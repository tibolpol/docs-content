...
<Message type="requirement">
  ...
  - You have generated a [virtual MAC](/dedibox-network/ip-failover/concepts/#virtual-mac-address) address
...
## Associate Virtual MAC Address to VM Network Adapter

As a requirement, the IP Address and the virtual MAC Address must have been added to the virtual hardware configuration of the VM.
